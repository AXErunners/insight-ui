...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/axecore-node:/insight/node_modules/@axerunners/insight-ui/axecore-node`,
        `${rootPath}/po:/insight/node_modules/@axerunners/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/@axerunners/insight-ui/public`,
      ],
    };
    ...
    await masterNode.axeCore.getApi().generate(15);
  });
  ...
  describe('Home Page', () => {
    ...
    it('should be able search by block number', async () => {
      ...
      expect(blockReward).equal('500 AXE');
